...
//
//     final coinapi = coinapiFromJson(jsonString);

import 'dart:convert';

List<Coinapi> coinapiFromJson(String str) => List<Coinapi>.from(json.decode(str).map((x) => Coinapi.fromJson(x)));

String coinapiToJson(List<Coinapi> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Coinapi {
    ...
    factory Coinapi.fromJson(Map<String, dynamic> json) => Coinapi(
        id: json["id"],
        symbol: json["symbol"],
        name: json["name"],
        image: json["image"],
